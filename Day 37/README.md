...
* This is commonly used by:
  ...
  * Humans using client certificates generated by `kubeadm` or `cfssl`
...
1. **ServiceAccount Automatically Mounted**
   Whenever a Pod is created — whether by a Deployment, StatefulSet, ReplicaSet, DaemonSet, or directly — a ServiceAccount (SA) is automatically associated with it.
